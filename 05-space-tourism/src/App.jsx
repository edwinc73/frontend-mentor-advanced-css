...
function App() {
  return (
    <>
      ...
      >
        <div className="max-w-[1440px] mx-auto flex lg:items-end lg:pt-[160px] min-h-[1024px] md:pb-1600 px-500 lg:px-[165px] pt-1600 pb-300 lg:pb-1600 overflow-clip">
          <div className="home__container w-full h-full flex flex-col lg:flex-row xl:justify-between items-center gap-800 max-h-[1024px] flex-grow">
            {/* description */}
            <article className="home__description flex flex-col gap-300 w-full text-center lg:text-left max-w-lg lg:h-full">
              <span className="font-barlowCondense text-blueLight tracking-[0.15rem] md:tracking-wide md:text-2xl">
                SO, YOU WANT TO TRAVEL TO
              </span>
              <h1 className="text-[5rem] leading-[7.5rem] md:text-6xl font-bellefair uppercase text-white">
                Space
              </h1>
