...
function Destination() {
  ...
  return (
    ...
    >
      <div className="max-w-[1440px] min-h-screen text-center gap-300 mx-auto flex flex-col items-center lg:block md:pt-[134px] lg:pt-[160px] h-full md:pb-300 px-300 md:px-500 lg:px-[165px] pt-[112px] pb-300 lg:pb-600">
        {/* title */}
